...
static const struct wmt_pinctrl_bank_registers wm8505_banks[] = {
	...
	WMT_PINCTRL_BANK(0x54, 0x7C, 0xA4, 0xCC, NO_REG, NO_REG),	/* 6 */
	WMT_PINCTRL_BANK(0x58, 0x80, 0xA8, 0xD0, NO_REG, NO_REG),	/* 7 */
	WMT_PINCTRL_BANK(0x5C, 0x84, 0xAC, 0xD4, NO_REG, NO_REG),	/* 8 */
	WMT_PINCTRL_BANK(0x60, 0x88, 0xB0, 0xD8, NO_REG, NO_REG),	/* 9 */
